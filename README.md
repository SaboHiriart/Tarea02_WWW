...
Curriculum Vitae implementado un framework de Diseño
...
Entregable
• link del sitio web en productivo (heroku) (<?php header( 'Location: /index.html' ) ; ?>) se necesita esta linea para subirlo en un archivo con ext php
